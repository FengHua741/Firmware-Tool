...
def _path_in_update_dir(path, manufacturer):
    try:
        base = os.path.realpath(_firmware_update_dir(manufacturer))
...
def get_firmware_update_config(manufacturer, config_id):
    ...
    try:
        ...
        filepath = os.path.join(_firmware_update_dir(manufacturer), f"{config_id}.json")
